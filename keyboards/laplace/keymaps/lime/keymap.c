...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT(
            KC_GRAVE  , KC_PIPE     , KC_BSLASH     , KC_LEFT_CURLY_BRACE , KC_RIGHT_CURLY_BRACE , KC_UNDERSCORE , _______        , _______     , KC_HOME     , KC_END      , KC_PGUP      , KC_PGDN      , KC_DEL  ,
            KC_LCTL   , KC_TILDE    , KC_UNDERSCORE , KC_LEFT_PAREN       , KC_RIGHT_PAREN       , KC_PLUS       , KC_LEFT        , KC_DOWN     , KC_UP       , KC_RGHT     , KC_INS       , KC_ENT       ,
            KC_LSFT   , KC_PLUS     , KC_UNDERSCORE , KC_LBRC             , KC_RBRC              , _______       , _______        , _______     , KC_PSCREEN  , KC_MUTE     , KC_VOLD      , KC_VOLU      ,
