...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT(
            ...
            KC_LCTL  , _______     , KC_UNDERSCORE , KC_LEFT_PAREN       , KC_RIGHT_PAREN       , KC_PLUS       , KC_LEFT     , KC_DOWN     , KC_UP       , KC_RGHT     , KC_INS       , KC_ENT          ,
            KC_LSFT  , _______     , KC_PLUS       , KC_LBRC             , KC_RBRC              , _______       , _______     , _______     , KC_PSCREEN  , KC_MUTE     , KC_VOLD      , KC_VOLU         ,
