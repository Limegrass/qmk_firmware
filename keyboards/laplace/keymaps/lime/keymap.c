...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
            ...
            FN1              , OSL3          , KC_LGUI     , KC_LALT             , ESC_FN2              , SPACE_FN3     , KC_TILDE    , TT(_FN4)    , KC_BSLS        , ENTER_FN2)

                             ,
    [_FN1] = LAYOUT(
            KC_GRAVE         , KC_EXCLAIM    , KC_AT       , KC_LEFT_CURLY_BRACE , KC_RIGHT_CURLY_BRACE , KC_UNDERSCORE , _______     , _______     , KC_HOME     , KC_END      , KC_PGUP      , KC_PGDN         , KC_DEL  ,
            KC_LCTL          , KC_HASH       , KC_ASTERISK , KC_LEFT_PAREN       , KC_RIGHT_PAREN       , KC_PLUS       , KC_LEFT     , KC_DOWN     , KC_UP       , KC_RGHT     , KC_INS       , KC_ENT          ,
            KC_LSFT          , KC_CIRCUMFLEX , KC_DOLLAR   , KC_LBRC             , KC_RBRC              , _______       , _______     , _______     , KC_PSCREEN  , KC_MUTE     , KC_VOLD      , KC_VOLU         ,
            _______          , _______       , KC_LGUI     , KC_LALT             , KC_COLON             , KC_ENT        , KC_MPLY     , KC_MSTP     , KC_MPRV     , KC_MNXT
            )
