...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
            ...
            FN1      , OSL3        , KC_LGUI       , KC_LALT             , ESC_FN2              , SPACE_FN3     , LALT(KC_GRAVE) , TT(_FN4)    , KC_BSLS     , ENTER_FN2)  ,

    [_FN1] = LAYOUT(
            KC_GRAVE , KC_MINUS    , KC_BSLASH     , KC_LEFT_CURLY_BRACE , KC_RIGHT_CURLY_BRACE , KC_UNDERSCORE , _______        , _______     , KC_HOME     , KC_END      , KC_PGUP      , KC_PGDN         , KC_DEL  ,
            KC_LCTL  , KC_PIPE     , KC_UNDERSCORE , KC_LEFT_PAREN       , KC_RIGHT_PAREN       , KC_PLUS       , KC_LEFT        , KC_DOWN     , KC_UP       , KC_RGHT     , KC_INS       , KC_ENT          ,
            KC_LSFT  , KC_TILDE    , KC_PLUS       , KC_LBRC             , KC_RBRC              , _______       , _______        , _______     , KC_PSCREEN  , KC_MUTE     , KC_VOLD      , KC_VOLU         ,
            _______  , _______     , KC_LGUI       , KC_LALT             , KC_COLON             , KC_ENT        , KC_MPRV        , KC_MPLY     , KC_MSTP     , KC_MNXT)    ,

    [_FN2] = LAYOUT(
            KC_EQL   , KC_1        , KC_2          , KC_3                , KC_4                 , KC_5          , KC_6           , KC_7        , KC_8        , KC_9        , KC_0         , KC_MINS         , KC_BSPC ,
            KC_LCTL  , LSFT(KC_1)  , LSFT(KC_2)    , LSFT(KC_3)          , LSFT(KC_4)           , LSFT(KC_5)    , LSFT(KC_6)     , LSFT(KC_7)  , LSFT(KC_8)  , LSFT(KC_9)  , LSFT(KC_0)   , KC_ENT          ,
            KC_LSFT  , LGUI(KC_1)  , LGUI(KC_2)    , LGUI(KC_3)          , LGUI(KC_4)           , LGUI(KC_5)    , LGUI(KC_6)     , LGUI(KC_7)  , LGUI(KC_8)  , LGUI(KC_9)  , LGUI(KC_0)   , KC_RSFT         ,
            _______  , _______     , KC_LGUI       , KC_LALT             , _______              , KC_BSPC       , _______        , _______     , _______     , _______)    ,
    ...
    [_FN4] = LAYOUT(
            KC_TAB   , _______     , _______       , _______             , _______              , _______       , KC_PAST        , KC_7        , KC_8        , KC_9        , KC_EQL       , KC_DEL          , KC_BSPC ,
            KC_LCTL  , _______     , _______       , _______             , _______              , _______       , KC_SLSH        , KC_4        , KC_5        , KC_6        , KC_MINS      , KC_ENT          ,
            KC_LSFT  , _______     , _______       , _______             , _______              , _______       , KC_DOT         , KC_1        , KC_2        , KC_3        , KC_UP        , KC_DOWN         ,
