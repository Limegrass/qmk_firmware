...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_HARDWARE] = LAYOUT_planck_mit(
            ...
            RGB_TOG       , RGB_MOD       , KC_LGUI    , KC_LALT        , QWERTY     , COLEMAK_DHM , DF(_GAMEBASE) , DF(_FPS) , QK_BOOTLOADER , XXXXXXX , QK_BOOTLOADER
            )             ,
    ...
    [_GAMEBASE] = LAYOUT_planck_mit(
            ...
            MO(_GAMENUMBER) , MO(_GAMEFUNCTION) , KC_LGUI , KC_LALT , KC_SPACE , KC_SPACE , LT(_GAMEFUNCTION , KC_ENTER) , KC_RALT , QWERTY , KC_ESCAPE , TT(_HARDWARE)
            )               ,
    ...
    [_GAMENUMBER] = LAYOUT_planck_mit(
            ...
            _______         , OSL(_GAMEFUNCTION) , _______ , _______ , _______ , _______ , QWERTY , KC_MPRV , KC_MPLY , KC_MSTP , KC_MNXT
            )               ,
    ...
    [_GAMEFUNCTION] = LAYOUT_planck_mit(
            ...
            _______  , _______ , _______ , _______ , _______ , _______ , QWERTY , _______ , _______ , _______ , _______
            ),
    ...
    [_FPS] = LAYOUT_planck_mit(
            ...
            KC_LCTL  , KC_A            , KC_S    , KC_D    , KC_F     , KC_G     , KC_H             , KC_J      , KC_K    , KC_L      , KC_SCLN   , KC_QUOTE      ,
            KC_LSFT  , KC_Z            , KC_X    , KC_C    , KC_V     , KC_B     , KC_N             , KC_M      , KC_COMM , KC_DOT    , KC_SLSH   , KC_RSFT       ,
            KC_LCTL  , MO(_GAMENUMBER) , KC_LGUI , KC_LALT , KC_SPACE , KC_SPACE , LT(_GAMEFUNCTION , KC_ENTER) , KC_RALT , QWERTY , KC_ESCAPE , TT(_HARDWARE)
            )        ,
};
