...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
            ...
            FN1     , OSL2 , KC_LGUI , KC_LALT , ESC_FN2 , SPACE_FN3 , TT(_FN4) , KC_GRAVE , OSL3    , ENTER_FN2
            )
    ...
    [_FN4] = LAYOUT(
            ...
            KC_LSFT , _______ , _______ , _______ , _______ , _______ , KC_DOT  , KC_1    , KC_2    , KC_3    , KC_UP   , KC_TAB ,
