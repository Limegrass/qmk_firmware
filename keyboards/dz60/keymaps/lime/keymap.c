...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        FN1            , KC_LGUI    , KC_LALT       , ESC_FN2             , SPACE_FN3            , SPACE_FN2     , LALT(KC_GRAVE) , KC_BSLS    , XXXXXXX    , TT(_FN5)   , KC_RCTL)   ,

    [_FN1] = LAYOUT(
        KC_GRV         , KC_F1      , KC_F2         , KC_F3               , KC_F4                , KC_F5         , KC_F6          , KC_F7      , KC_F8      , KC_F9      , KC_F10     , KC_F11        , KC_F12         , _______ , KC_DEL  ,
        KC_GRAVE       , KC_PIPE    , KC_BSLASH     , KC_LEFT_CURLY_BRACE , KC_RIGHT_CURLY_BRACE , KC_UNDERSCORE , _______        , _______    , KC_HOME    , KC_END     , KC_PGUP    , KC_PGDN       , KC_DEL         , _______ ,
        KC_LCTL        , KC_TILDE   , KC_UNDERSCORE , KC_LEFT_PAREN       , KC_RIGHT_PAREN       , KC_PLUS       , KC_LEFT        , KC_DOWN    , KC_UP      , KC_RGHT    , KC_INS     , KC_ENT        , _______        ,
        KC_LSFT        , _______    , KC_PLUS       , KC_UNDERSCORE       , KC_LBRC              , KC_RBRC       , _______        , _______    , KC_PSCREEN , KC_MUTE    , KC_VOLD    , KC_VOLU       , _______        , _______ ,
        _______        , KC_LGUI    , KC_LALT       , KC_COLON            , KC_BSPC              , KC_ENTER      , _______        , _______    , _______    , FN4        , _______)   ,

    [_FN2] = LAYOUT(
        _______        , _______    , _______       , _______             , _______              , _______       , _______        , _______    , _______    , _______    , _______    , _______       , _______        , _______ , _______ ,
        KC_EQL         , KC_1       , KC_2          , KC_3                , KC_4                 , KC_5          , KC_6           , KC_7       , KC_8       , KC_9       , KC_0       , KC_MINS       , KC_EQL         , _______ ,
        KC_LCTL        , LSFT(KC_1) , LSFT(KC_2)    , LSFT(KC_3)          , LSFT(KC_4)           , LSFT(KC_5)    , LSFT(KC_6)     , LSFT(KC_7) , LSFT(KC_8) , KC_PLUS    , KC_MINUS   , LSFT(KC_MINS) , LSFT(KC_EQL)   ,
        KC_LSFT        , _______    , LGUI(KC_1)    , LGUI(KC_2)          , LGUI(KC_3)           , LGUI(KC_4)    , LGUI(KC_5)     , LGUI(KC_6) , LGUI(KC_7) , LGUI(KC_8) , LGUI(KC_9) , LGUI(KC_0)    , KC_MPLY        , _______ ,
        KC_BSPC        , KC_LGUI    , KC_LALT       , _______             , KC_BSPC              , KC_DEL        , _______        , _______    , KC_MPRV    , KC_MSTP    , KC_MNXT)   ,
