...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        FN1            , KC_LGUI    , KC_LALT       , ESC_FN2             , SPACE_FN2            , SPACE_FN3     , LALT(KC_GRAVE) , KC_BSLS    , XXXXXXX    , TT(_FN5)   , KC_RCTL)   ,

    [_FN1] = LAYOUT(
        KC_GRV         , KC_F1      , KC_F2         , KC_F3               , KC_F4                , KC_F5         , KC_F6          , KC_F7      , KC_F8      , KC_F9      , KC_F10     , KC_F11        , KC_F12         , _______ , KC_DEL  ,
        KC_GRAVE       , KC_MINUS   , KC_BSLASH     , KC_LEFT_CURLY_BRACE , KC_RIGHT_CURLY_BRACE , KC_UNDERSCORE , _______        , _______    , KC_HOME    , KC_END     , KC_PGUP    , KC_PGDN       , KC_DEL         , _______ ,
        KC_LCTL        , KC_PIPE    , KC_UNDERSCORE , KC_LEFT_PAREN       , KC_RIGHT_PAREN       , KC_PLUS       , KC_LEFT        , KC_DOWN    , KC_UP      , KC_RGHT    , KC_INS     , KC_ENT        , _______        ,
        KC_LSFT        , _______    , KC_TILDE      , KC_PLUS             , KC_LBRC              , KC_RBRC       , _______        , _______    , KC_PSCREEN , KC_MUTE    , KC_VOLD    , KC_VOLU       , _______        , _______ ,
