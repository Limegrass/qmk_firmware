...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        FN1          , KC_LGUI    , KC_LALT       , ESC_FN2             , SPACE_FN2            , SPACE_FN3     , KC_TILDE   , KC_BSLS    , XXXXXXX    , TT(_FN5)   , KC_RCTL)   ,
    ...
    [_FN1] = LAYOUT(
        ...
        KC_LCTL      , _______    , KC_UNDERSCORE , KC_LEFT_PAREN       , KC_RIGHT_PAREN       , KC_PLUS       , KC_LEFT    , KC_DOWN    , KC_UP      , KC_RGHT    , KC_INS     , KC_ENT        , _______        ,
        KC_LSFT      , _______    , _______       , KC_PLUS             , KC_LBRC              , KC_RBRC       , _______    , _______    , KC_PSCREEN , KC_MUTE    , KC_VOLD    , KC_VOLU       , _______        , _______ ,
